                                               ...
                                               gboolean       cancelled)
{
    ...
    if (error != NULL)
    {
        ...
        dialog_error(GTK_WIDGET(LAUNCHER(browser)->widget), error, _("Failed to mount \"%s\""), device_name);
        g_free(device_name);
    }
    ...
    if (poke_data->files_to_poke == NULL)
    {
        ...
        if (files != NULL)
        {
            ...
            else
            {
                ...
                _launcher_open_files(LAUNCHER(browser), files, poke_data->application_to_use);
            }
