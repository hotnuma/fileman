...
static gint g_app_info_compare(gpointer a, gpointer b)
{
 ...
 **/
ThunarSendtoModel* thunar_sendto_model_get_default()
{
 ...
 **/
GList* thunar_sendto_model_get_matching(ThunarSendtoModel *sendto_model, GList *files)
{
