...
GdkPixbuf *egdk_pixbuf_colorize                  (const GdkPixbuf *source,
...
GdkPixbuf *egdk_pixbuf_lucent                    (const GdkPixbuf *source,
                                                     guint            percent) G_GNUC_MALLOC G_GNUC_WARN_UNUSED_RESULT;

GdkPixbuf *egdk_pixbuf_spotlight                 (const GdkPixbuf *source) G_GNUC_MALLOC G_GNUC_WARN_UNUSED_RESULT;
...
GdkPixbuf *egdk_pixbuf_scale_ratio               (GdkPixbuf       *source,
