 ...
 **/
GdkPixbuf*
egdk_pixbuf_colorize (const GdkPixbuf *source,
 ...
 **/
GdkPixbuf*
egdk_pixbuf_frame (const GdkPixbuf *source,
 ...
 **/
GdkPixbuf*
egdk_pixbuf_spotlight (const GdkPixbuf *source)
{
  GdkPixbuf *dst;
  gboolean   has_alpha;
  gint       dst_row_stride;
 ...
 **/
GdkPixbuf*
egdk_pixbuf_scale_down (GdkPixbuf *source,
 ...
 **/
GdkPixbuf*
egdk_pixbuf_new_from_file_at_max_size (const gchar *filename,
                                          gint         max_width,
                                          gint         max_height,
                                          gboolean     preserve_aspect_ratio,
                                          GError     **error)
