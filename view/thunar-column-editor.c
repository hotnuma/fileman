...
static void _thunar_column_editor_help_clicked(GtkWidget *button,
                                               ThunarColumnEditor *column_editor);
static void _thunar_column_editor_move_down(GtkWidget *button,
                                            ThunarColumnEditor *column_editor);
static void _thunar_column_editor_move_up(GtkWidget *button,
                                          ThunarColumnEditor *column_editor);
static void _thunar_column_editor_toggled(GtkCellRendererToggle *cell_renderer,
                                          const gchar *path_string,
                                          ThunarColumnEditor *column_editor);
static void _thunar_column_editor_toggle_visibility(GtkWidget *button,
                                                    ThunarColumnEditor *column_editor);
static void _thunar_column_editor_update_buttons(ThunarColumnEditor *column_editor);
static void _thunar_column_editor_use_defaults(GtkWidget *button,
                                               ThunarColumnEditor *column_editor);
...
G_DEFINE_TYPE(ThunarColumnEditor, thunar_column_editor, GTK_TYPE_DIALOG)
...
static void thunar_column_editor_init(ThunarColumnEditor *column_editor)
{
    ...
    g_signal_connect_data(G_OBJECT(column_editor->column_model), "row-changed", G_CALLBACK(_thunar_column_editor_update_buttons),
                           column_editor, NULL, G_CONNECT_AFTER | G_CONNECT_SWAPPED);
    g_signal_connect_data(G_OBJECT(column_editor->column_model), "rows-reordered", G_CALLBACK(_thunar_column_editor_update_buttons),
                           column_editor, NULL, G_CONNECT_AFTER | G_CONNECT_SWAPPED);
    ...
    g_signal_connect(G_OBJECT(button), "clicked", G_CALLBACK(_thunar_column_editor_help_clicked), column_editor);
    ...
    g_signal_connect(G_OBJECT(renderer), "toggled", G_CALLBACK(_thunar_column_editor_toggled), column_editor);
    ...
    g_signal_connect(G_OBJECT(column_editor->up_button), "clicked", G_CALLBACK(_thunar_column_editor_move_up), column_editor);
    ...
    g_signal_connect(G_OBJECT(column_editor->down_button), "clicked", G_CALLBACK(_thunar_column_editor_move_down), column_editor);
    ...
    g_signal_connect(G_OBJECT(column_editor->show_button), "clicked", G_CALLBACK(_thunar_column_editor_toggle_visibility), column_editor);
    ...
    g_signal_connect(G_OBJECT(column_editor->hide_button), "clicked", G_CALLBACK(_thunar_column_editor_toggle_visibility), column_editor);
    ...
    g_signal_connect(G_OBJECT(button), "clicked", G_CALLBACK(_thunar_column_editor_use_defaults), column_editor);
    ...
    g_signal_connect_swapped(G_OBJECT(selection), "changed", G_CALLBACK(_thunar_column_editor_update_buttons), column_editor);
...
static void _thunar_column_editor_help_clicked(GtkWidget          *button,
                                               ThunarColumnEditor *column_editor)
{
    thunar_return_if_fail(THUNAR_IS_COLUMN_EDITOR(column_editor));
                                          ...
                                          ThunarColumnEditor    *column_editor)
{
    ...
    thunar_return_if_fail(GTK_IS_CELL_RENDERER_TOGGLE(cell_renderer));
    thunar_return_if_fail(THUNAR_IS_COLUMN_EDITOR(column_editor));
    thunar_return_if_fail(path_string != NULL);
