...
static GObject *thunar_standard_view_constructor(
                                    GType type,
...
static ThunarFile *thunar_standard_view_get_current_directory(
                                            ThunarNavigator *navigator);
static void thunar_standard_view_set_current_directory(
                                            ThunarNavigator *navigator,
...
static gboolean thunar_standard_view_motion_notify_event(
                                            ...
                                            ThunarStandardView *standard_view);
static gboolean thunar_standard_view_scroll_event(
                                            GtkWidget *view,
...
static void _standard_view_select_after_row_deleted(
                                            ...
                                            GtkTreePath *path,
                                            ThunarStandardView *standard_view);
static gboolean thunar_standard_view_restore_selection_idle(
                                            ThunarStandardView *standard_view);
static void thunar_standard_view_row_changed(ThunarListModel *model,
                                             GtkTreePath *path,
                                             GtkTreeIter *iter,
                                             ThunarStandardView *standard_view);
static void thunar_standard_view_rows_reordered(
                                            ThunarListModel *model,
                                            GtkTreePath *path,
                                            GtkTreeIter *iter,
                                            gpointer new_order,
...
static void thunar_standard_view_error(ThunarListModel *model,
                                       const GError *error,
                                       ThunarStandardView *standard_view);
static void thunar_standard_view_sort_column_changed(
...
static void thunar_standard_view_drag_begin(GtkWidget *view,
                                            GdkDragContext *context,
                                            ThunarStandardView *standard_view);
static void thunar_standard_view_drag_data_get(
                                            GtkWidget *view,
                                            GdkDragContext *context,
                                            ...
                                            guint timestamp,
                                            ThunarStandardView *standard_view);
static void thunar_standard_view_drag_data_delete(
                                            GtkWidget *view,
                                            GdkDragContext *context,
                                            ThunarStandardView *standard_view);
...
static void thunar_standard_view_drag_leave(GtkWidget *view,
                                            ...
                                            guint timestamp,
                                            ThunarStandardView *standard_view);
static gboolean thunar_standard_view_drag_motion(
                                            GtkWidget *view,
                                            GdkDragContext *context,
                                            gint x,
                                            gint y,
                                            guint timestamp,
                                            ThunarStandardView *standard_view);
static gboolean thunar_standard_view_drag_drop(
                                            GtkWidget *view,
                                            GdkDragContext *context,
                                            gint x,
                                            gint y,
                                            guint timestamp,
                                            ThunarStandardView *standard_view);
static void thunar_standard_view_drag_data_received(
                                            GtkWidget *view,
                                            GdkDragContext *context,
                                            gint x,
                                            gint y,
...
G_DEFINE_ABSTRACT_TYPE_WITH_CODE(ThunarStandardView,
                                 standard_view,
                                 GTK_TYPE_SCROLLED_WINDOW,
                                 G_IMPLEMENT_INTERFACE(
                                     THUNAR_TYPE_NAVIGATOR,
                                     thunar_standard_view_navigator_init)
                                 G_IMPLEMENT_INTERFACE(
...
static void standard_view_init(ThunarStandardView *standard_view)
{
    ...
    g_signal_connect(G_OBJECT(standard_view->model),
                     "rows-reordered",
                     G_CALLBACK(thunar_standard_view_rows_reordered),
                     standard_view);
    g_signal_connect(G_OBJECT(standard_view->model),
                     "error",
                     G_CALLBACK(thunar_standard_view_error),
                     standard_view);
    ...
    g_signal_connect_swapped(G_OBJECT(standard_view->model),
                             "notify::folder",
                             G_CALLBACK(thunar_standard_view_selection_changed),
                             standard_view);
    ...
    g_signal_connect_after(G_OBJECT(standard_view),
                           "size-allocate",
                           G_CALLBACK(thunar_standard_view_size_allocate),
                           NULL);
                                    ...
                                    GObjectConstructParam *construct_properties)
{
    ...
    g_signal_connect(G_OBJECT(view), "key-press-event",
                     G_CALLBACK(thunar_standard_view_key_press_event), object);
    ...
    g_signal_connect(G_OBJECT(view), "drag-begin",
                     G_CALLBACK(thunar_standard_view_drag_begin), object);
    g_signal_connect(G_OBJECT(view), "drag-data-get",
                     G_CALLBACK(thunar_standard_view_drag_data_get), object);
    g_signal_connect(G_OBJECT(view), "drag-data-delete",
                     G_CALLBACK(thunar_standard_view_drag_data_delete), object);
    g_signal_connect(G_OBJECT(view), "drag-end",
                     G_CALLBACK(thunar_standard_view_drag_end), object);
    ...
    g_signal_connect(G_OBJECT(view), "drag-leave",
                     G_CALLBACK(thunar_standard_view_drag_leave), object);
    g_signal_connect(G_OBJECT(view), "drag-motion",
                     G_CALLBACK(thunar_standard_view_drag_motion), object);
    g_signal_connect(G_OBJECT(view), "drag-drop",
                     G_CALLBACK(thunar_standard_view_drag_drop), object);
    g_signal_connect(G_OBJECT(view), "drag-data-received",
                     G_CALLBACK(thunar_standard_view_drag_data_received), object);
...
static void thunar_standard_view_set_selected_files_view(
                                                    ThunarView *view,
                                                    GList      *selected_files)
{
...
static void
_standard_view_update_statusbar_text(ThunarStandardView *standard_view)
{
 ...
 */
static ThunarFile* thunar_standard_view_get_fallback_directory(
                                               ...
                                               ThunarStandardView *standard_view)
{
    ...
    thunar_return_if_fail(standard_view->priv->current_directory == current_directory);
                                            ...
                                            ThunarStandardView *standard_view)
{
    ...
    thunar_return_if_fail(path != NULL);
    thunar_return_if_fail(THUNAR_IS_STANDARD_VIEW(standard_view));
...
static void thunar_standard_view_scrolled(GtkAdjustment      *adjustment,
                                          ThunarStandardView *standard_view)
{
    thunar_return_if_fail(GTK_IS_ADJUSTMENT(adjustment));
    thunar_return_if_fail(THUNAR_IS_STANDARD_VIEW(standard_view));
...
static void thunar_standard_view_drag_leave(GtkWidget          *widget,
                                            GdkDragContext     *context,
                                            guint               timestamp,
                                            ThunarStandardView *standard_view)
{
