        ...
        && (job->last_update_time - job->start_time) > MINIMUM_TRANSFER_TIME)
    {
        ...
        if (remaining_time > 0)
        {
            ...
            if (remaining_time > 60 * 60)
            {
                ...
                g_string_append_printf(status, ngetstr("%lu hour remaining(%s/sec)",
            ...
            else if (remaining_time > 60)
            {
                ...
                g_string_append_printf(status, ngetstr("%lu minute remaining(%s/sec)",
            ...
            {
                g_string_append_printf(status, ngetstr("%lu second remaining(%s/sec)",
